...
const About = () => {
  return (
    <div>
      <main className="text-white flex flex-col items-center py-8 sm:py-16 min-h-screen">
        <h1 className="text-2xl sm:text-4xl font-bold underline">About Us</h1>
        <p className="text-base sm:text-lg px-3 sm:px-8 md:px-24 py-3 sm:py-5">
